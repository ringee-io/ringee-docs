...
|---|---|---|
| [`call.completed`](#call-completed) | A call technically ended | Opt in |
| [`call.outcome.updated`](#call-outcome-updated) | A user set or changed a call outcome | Opt in |
| [`call.missed`](#call-missed) | An inbound call was not answered | Opt in |
| [`call.failed`](#call-failed) | A call failed technically | Opt in |
| [`note.created`](#note-created) | A note was added to a contact | Opt in |
| [`callback.created`](#callback-created) | A callback was scheduled | Opt in |
| [`meeting.created`](#meeting-created) | A meeting was scheduled | Opt in |
| [`recording.ready`](#recording-ready) | A recording finished processing | Opt in |
| [`dnc.created`](#dnc-created) | A number was added to Do Not Call | Opt in |
| [`test.ping`](#test-ping) | You click **Test webhook** | Always |
